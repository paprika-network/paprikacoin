...
rm -rf ~/paprikacoincoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../paprikacoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../paprikacoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/paprikacoincoin/temp
cd ~/paprikacoincoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/paprikacoincoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/paprikacoincoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
