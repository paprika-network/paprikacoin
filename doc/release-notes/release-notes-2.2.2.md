Paprikacoin Core version *2.2.2* is now available!!
==============
...
- Enhancements for Paprikacoin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/JustAResearcher/Paprikacoin/commits/release_2.2.2>
