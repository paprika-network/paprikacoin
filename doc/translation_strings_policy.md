...
This document provides guidelines for internationalization of the Paprikacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `paprikacoin_en.ts` remains unchanged.
