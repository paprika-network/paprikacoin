...
#ifndef PAPRIKA_VALIDATION_H
#define PAPRIKA_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for paprikacoin, with 1 minutes block intervals?
