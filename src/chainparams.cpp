...
// Copyright (c) 2017-2023 The Paprikacoin__Core developers
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1676724610; // Friday, 20 May 2022 00:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1679152854; // Monday, 23 May 2022 00:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ASSETS].nStartTime = 1676724610; // Friday, 20 May 2022 00:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_ASSETS].nTimeout = 1679152854; // Monday, 23 May 2022 00:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MSG_REST_ASSETS].nStartTime = 1676724610; // Friday, 20 May 2022 00:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_MSG_REST_ASSETS].nTimeout = 1679152854; // Monday, 23 May 2022 00:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nStartTime = 1676724610; // Friday, 20 May 2022 00:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nTimeout = 1679152854; // Monday, 23 May 2022 00:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nStartTime = 1676724610; // Friday, 20 May 2022 00:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nTimeout = 1679152854; // Monday, 23 May 2022 00:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nStartTime = 1676724610; // Friday, 20 May 2022 00:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nTimeout = 1679152854; // Monday, 23 May 2022 00:00:00
        ...
        consensus.nMinimumChainWork = uint256S("0x"); // Block 50000

        // By default assume that the signatures in ancestors of this block are valid
        consensus.defaultAssumeValid = uint256S("0x"); // Block 50000
	    ...
	    uint32_t nGenesisTime = 1676724610;	
	    genesis = CreateGenesisBlock(nGenesisTime, 4028486, 0x1e00ffff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();	
	    assert(consensus.hashGenesisBlock == uint256S("0x000000593fb70307466b94200bb12781a26d956239576eb0dbd820f8cff65c08"));
	 ...
	 vSeeds.emplace_back("seed1.paprikacoin.org", false);
        ...
        // PAPRIKA BIP44 cointype in mainnet is '1669'
        nExtCoinType = 1669;
		...
		{165740, uint256S("0x0000000000858ed94a68a43eba52f254111c0d3c99fcaa4f53dff7d6ef3fee10")},
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Paprikacoin chain from rpc: getchaintxstats 50000
        ...
        // 40% of 60 COIN to Dev+team and community
	    nCommunityAutonomousAmount = 40;

        // Burn Addresses
	    strIssueAssetBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        strReissueAssetBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        strIssueSubAssetBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        strIssueUniqueAssetBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        strIssueMsgChannelAssetBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        strIssueQualifierAssetBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        strIssueSubQualifierAssetBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        strIssueRestrictedAssetBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        strAddNullQualifierTagBurnAddress = "94NGAK1HyWoa4TJgMbQPErJrYCRbdkZeCu";
        
        //Global Burn Address
        strGlobalBurnAddress = "9CBurnXXXXXXXXXXXXXXXXXXXXXXUkdzqy";

        // Donation Address
        strCommunityAutonomousAddress = "9HG8eFYxzUMLfaJwTL18M5hbRcs65eA4Re";
        ...
        nKAAAWWWPOWActivationTime = 1676729612;
...
public:
    CTestNetParams() {
       ...
       // assert(genesis.hashMerkleRoot == uint256S("0xe8916cf6592c8433d598c3a5fe60a9741fd2a997b39d93af2d789cdd9d9a7390"));		
        ...
        // Paprikacoin BIP44 cointype in testnet
        nExtCoinType = 1;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Paprikacoin chain
...
public:
    CRegTestParams() {
        ...
        // Paprikacoin BIP44 cointype in regtest
        nExtCoinType = 1;
