...
#ifndef PAPRIKA_SCRIPT_STANDARD_H
#define PAPRIKA_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_PAPRIKA_ASSET script that carries data
    /** PAPRIKA END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a paprikacoin address
 */
...
/**
 * Generate a Paprikacoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // PAPRIKA_SCRIPT_STANDARD_H
