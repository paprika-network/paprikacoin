...
#ifndef PAPRIKA_RPCSERVER_H
#define PAPRIKA_RPCSERVER_H
...
/**
 * Paprikacoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isPAPRY = true);
