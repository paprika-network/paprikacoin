...
CAmount AmountFromValue(const UniValue& value, bool p_isPAPRY)
{
    ...
    if (p_isPAPRY && !MoneyRange(amount))
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Paprikacoin server stopping";
}
...
{
    return "> paprikacoin-cli " + methodname + " " + args + "\n";
}
