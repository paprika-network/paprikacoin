...
BOOST_FIXTURE_TEST_SUITE(netbase_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
    {
        ...
        BOOST_CHECK(TestSplitHost("www.paprikacoincoin.net", "www.paprikacoincoin.net", -1));
        BOOST_CHECK(TestSplitHost("[www.paprikacoincoin.net]", "www.paprikacoincoin.net", -1));
        BOOST_CHECK(TestSplitHost("www.paprikacoincoin.net:80", "www.paprikacoincoin.net", 80));
        BOOST_CHECK(TestSplitHost("[www.paprikacoincoin.net]:80", "www.paprikacoincoin.net", 80));
