...
#ifndef PAPRIKA_TEST_SCRIPTNUM10_H
#define PAPRIKA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Paprikacoin Core 0.10.0, for cross-comparison.
 */
public:
