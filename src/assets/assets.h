...
#ifndef PAPRIKACOIN_ASSET_PROTOCOL_H
#define PAPRIKACOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_PAPRIKA_ASSET PAPRYQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_PAPRIKA_ASSET PAPRYO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_PAPRIKA_ASSET PAPRYR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_PAPRIKA_ASSET PAPRYT
...
#endif //PAPRIKACOIN_ASSET_PROTOCOL_H
