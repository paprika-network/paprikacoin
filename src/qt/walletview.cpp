...
void WalletView::setPaprikacoinGUI(PaprikacoinGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? PaprikacoinGUI::HD44_ENABLED : _walletModel->hdEnabled() ? PaprikacoinGUI::HD_ENABLED : PaprikacoinGUI::HD_DISABLED);
