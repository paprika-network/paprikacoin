...
#ifndef PAPRIKA_QT_PaprikacoinGUI_H
#define PAPRIKA_QT_PaprikacoinGUI_H
...
/**
  paprikacoin GUI main class. This class represents the main window of the paprikacoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PaprikacoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PaprikacoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~PaprikacoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a paprikacoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // PAPRIKA_QT_PaprikacoinGUI_H
