...
#ifndef PAPRIKA_QT_RESTRICTEDASSETSDIALOG_H
#define PAPRIKA_QT_RESTRICTEDASSETSDIALOG_H
...
/** Dialog for sending paprikacoin */
...
#endif // PAPRIKA_QT_RESTRICTEDASSETSSDIALOG_H
