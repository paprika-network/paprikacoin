...
#ifndef PAPRIKA_QT_PAPRIKAUNITS_H
#define PAPRIKA_QT_PAPRIKAUNITS_H
...
/** paprikacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PaprikacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PaprikacoinUnits(QObject *parent);
...
typedef PaprikacoinUnits::Unit PaprikacoinUnit;

#endif // PAPRIKA_QT_PAPRIKAUNITS_H
