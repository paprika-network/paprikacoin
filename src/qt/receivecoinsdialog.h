...
#ifndef PAPRIKA_QT_RECEIVECOINSDIALOG_H
#define PAPRIKA_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of paprikacoin */
...
#endif // PAPRIKA_QT_RECEIVECOINSDIALOG_H
