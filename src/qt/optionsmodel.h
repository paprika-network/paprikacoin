...
#ifndef PAPRIKA_QT_OPTIONSMODEL_H
#define PAPRIKA_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for paprikacoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // PaprikacoinUnits::Unit
...
#endif // PAPRIKA_QT_OPTIONSMODEL_H
