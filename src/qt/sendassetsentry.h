...
#ifndef PAPRIKA_QT_SENDASSETSENTRY_H
#define PAPRIKA_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending paprikacoin.
...
#endif // PAPRIKA_QT_SENDASSETSENTRY_H
