...
#include "qt/paprikacoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PaprikacoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_paprikacoin-qt -platform xcb      # Linux
//     src/qt/test/test_paprikacoin-qt -platform windows  # Windows
//     src/qt/test/test_paprikacoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PaprikacoinUnits::formatWithUnit(unit, balance, false, PaprikacoinUnits::separatorAlways);
    ...
    // Amount input
    PaprikacoinAmountField* amountInput = receiveCoinsDialog.findChild<PaprikacoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: paprikacoin:")) != -1);
