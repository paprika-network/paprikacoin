...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(PaprikacoinUnits::PAPRY),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->paprikacoinBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->paprikacoinBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(PaprikacoinUnits::formatWithUnit(unit, balance, false, PaprikacoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(PaprikacoinUnits::formatWithUnit(unit, unconfirmedBalance, false, PaprikacoinUnits::separatorAlways));
    ui->labelImmature->setText(PaprikacoinUnits::formatWithUnit(unit, immatureBalance, false, PaprikacoinUnits::separatorAlways));
    ui->labelTotal->setText(PaprikacoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, PaprikacoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(PaprikacoinUnits::formatWithUnit(unit, watchOnlyBalance, false, PaprikacoinUnits::separatorAlways));
    ui->labelWatchPending->setText(PaprikacoinUnits::formatWithUnit(unit, watchUnconfBalance, false, PaprikacoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(PaprikacoinUnits::formatWithUnit(unit, watchImmatureBalance, false, PaprikacoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(PaprikacoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, PaprikacoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("PAPRY")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the PAPRY balance grid from expanding and looking terrible when asset balance is hidden
