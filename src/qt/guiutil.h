...
#ifndef PAPRIKA_QT_GUIUTIL_H
#define PAPRIKA_QT_GUIUTIL_H
...
/** Utility functions used by the paprikacoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "paprikacoin:" URI into recipient object, return true on successful parsing
