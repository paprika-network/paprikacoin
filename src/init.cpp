 ...
 * between paprikacoind, and paprikacoin-qt and non-server tools.
*/
...
void PrepareShutdown()
{
    ...
    RenameThread("paprikacoin-shutoff");
    ...
    FlushWallets();
#endif
    GeneratePaprikacoins(false, 0, GetParams());
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), PAPRIKA_PID_FILENAME));
#endif
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("paprikacoin-loadblk");
...
/** Sanity checks
 *  Ensure that Paprikacoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Paprikacoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Paprikacoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", PAPRIKA_CONF_FILENAME)).string());
    ...
    GeneratePaprikacoins(fGenerate, gArgs.GetArg("-genproclimit", DEFAULT_GENERATE_THREADS), chainparams);
