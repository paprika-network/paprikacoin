 ...
 */
#ifndef PAPRIKA_UTIL_H
#define PAPRIKA_UTIL_H
...
extern const char *const PAPRIKA_CONF_FILENAME;
extern const char *const PAPRIKA_PID_FILENAME;
...
{
    std::string s = strprintf("paprikacoin-%s", name);
