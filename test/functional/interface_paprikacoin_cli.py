...
class TestPaprikacoinCli(PaprikacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `paprikacoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `paprikacoin-cli -getinfo` and the RPCs data is retrieved from.")
