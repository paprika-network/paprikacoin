...
class BIP66Test(PaprikacoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # paprikacoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and paprikacoind produces more specific reject
            # reasons.
