...
class WalletTest(PaprikacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PAPRY from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 PAPRY with subtract fee from amount
        ...
        # Sendmany 10 PAPRY with subtract fee from amount
