...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PaprikacoinTestFramework
    pass

class ExampleTest(PaprikacoinTestFramework):
    # Each functional test is a subclass of the PaprikacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        PaprikacoinTestFramework class so other tests can use it."""
