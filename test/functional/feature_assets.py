...
class AssetTest(PaprikacoinTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("PAPRIKA1", 1000)
        n0.issue("PAPRIKA2", 1000)
        n0.issue("PAPRIKA3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="PAPRIKA*", verbose=False, count=2, start=-2)
        ...
        paprikacoin_assets = n0.listassets(asset="PAPRIKA*", verbose=False, count=2, start=-2)
        assert_equal(len(paprikacoin_assets), 2)
        assert_equal(paprikacoin_assets[0], "PAPRIKA2")
        assert_equal(paprikacoin_assets[1], "PAPRIKA3")
        self.sync_all()
