...
import os
import struct
from test_framework.test_framework import PaprikacoinTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(PaprikacoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that paprikacoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("paprikacoind has not been built with zmq enabled.")
