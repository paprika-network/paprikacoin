...
class TxnMallTest(PaprikacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 PAPRY:
        ...
        # First: use raw transaction API to send 1240 PAPRY to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PAPRY coin each
        ...
        # Node0's balance should be starting balance, plus 50PAPRY for another
        ...
        # Node0's total balance should be starting balance, plus 100PAPRY for 
