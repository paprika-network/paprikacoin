...
# TestNode: A peer we use to send messages to paprikacoind, and store responses.
...
class CompactBlocksTest(PaprikacoinTestFramework):
    ...
    # This test actually causes paprikacoind to (reasonably!) disconnect us, so do this last.
    ...
    # paprikacoind's choice of nonce.
    ...
    # Test that paprikacoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for paprikacoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # paprikacoind will not send blocktxn responses for blocks whose height is
