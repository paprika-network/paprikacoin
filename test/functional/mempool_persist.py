...
By default, paprikacoind will dump mempool on shutdown and
...
class MempoolPersistTest(PaprikacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give paprikacoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent paprikacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
