...
class RewardsTest(PaprikacoinTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating PAPRY for node[0] and activating assets...")
    ...
    # Basic functionality test - PAPRY reward
    # - create the main owner address
    # - mine blocks to have enough PAPRY for the reward payments, plus purchasing the asset
    ...
    # - distribute an PAPRY reward amongst the shareholders
    # - verify that each one receives the expected amount of reward PAPRY
    def basic_test_neox(self):
        self.log.info("Running basic PAPRY reward test!")
        n0, n1, n2 = self.nodes[0], self.nodes[1], self.nodes[2]
        ...
        n0.distributereward(asset_name="STOCK1", snapshot_height=tgt_block_height, distribution_asset_name="PAPRY",
        ...
        self.log.info("Verifying PAPRY holdings after payout")
    ...
    # - create the main owner address
    # - mine blocks to have enough PAPRY for the reward fees, plus purchasing the asset
    ...
    def payout_without_snapshot(self):
        ...
        assert_raises_rpc_error(-32600, "Snapshot request not found",
                                n0.distributereward, "STOCK3", tgt_block_height, "PAPRY", 2000, owner_addr0)
    ...
    def payout_with_invalid_ownership_asset(self):
        ...
        assert_raises_rpc_error(-32600, "The asset hasn't been created: STOCK4",
                                n0.distributereward, "STOCK4", tgt_block_height, "PAPRY", 2000, owner_addr0)
    ...
    def payout_before_minimum_height_is_reached(self):
        ...
        assert_raises_rpc_error(-32600,
                                ...
                                n0.distributereward, "STOCK6", tgt_block_height, "PAPRY", 2000, owner_addr0)

    # Attempts a payout using a custom rewards height of 15, and they have low paprikacoin balance
    def payout_custom_height_set_with_low_funds(self):
        ...
        n1.distributereward("STOCK7", tgt_block_height, "PAPRY", 2000, owner_addr0)

        n1.generate(2)
        self.sync_all()

        assert_equal(n1.getdistributestatus("STOCK7", tgt_block_height, "PAPRY", 2000, owner_addr0)['Status'], 3)
    ...
    # Attempts a payout using a custom rewards height of 15, and they have low PAPRY balance
